...
impl Sandbox {
        ...
        F: FnOnce() -> Result<(), String>,
    {
        ...
        // Compare
        println!(
            "[Sandbox] Baseline: IPC={:?}, Cycles={:?}, RSS={}",
            baseline.ipc, baseline.cycles, baseline.peak_rss
        );
        println!(
            "[Sandbox] Candidate: IPC={:?}, Cycles={:?}, RSS={}",
            candidate.ipc, candidate.cycles, candidate.peak_rss
        );
